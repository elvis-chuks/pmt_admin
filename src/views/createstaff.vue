        ...
        <main>
            ...
            <section class="main-stuff">
                ...
                <div class="all-content">
                    <h1 class="top">Create new staff</h1>
                    <div class="form">
                        <div class="form-left">
                    ...
                    <div class="submit">
                        <p>{{remark}}</p>
                        <input type="checkbox" name="confirm" id="confirm" v-model="check" @click="confirm()"> Confirm update profile
                        <button class="submit" id="submit" @click="createStaff()" disabled>Submit</button>
                    </div>
    ...
    methods:{
        createStaff(){
            ...
            .then(data => {
                ...
                console.log(data)
                if(data.status == 'done'){
                    this.remark = "Succesfully created user"
                    window.location.reload()
                }
                else{
                    this.remark = "Error creating user"
                }
            })
        },
        confirm(){
